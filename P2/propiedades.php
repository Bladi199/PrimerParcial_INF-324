  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card card-body">
        <form action="guardar_catastro.php" method="GET"> <!-- Cambia POST a GET -->
        ...
        <a href="CRUD.php" class="btn btn-primary w-50 mt-2">Volver</a> <!-- Botón Volver -->
        </form>
      </div>
    </div>
    ...
    <div class="col-md-8">
      <?php
      // Verifica si se recibió el parámetro 'ci' desde la URL
      if (isset($_GET['ci'])) {
        $ci = $_GET['ci'];

        // Consulta para obtener las propiedades (catastros) relacionadas con el CI enviado
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="edit_c.php?ci=<?php echo $row['ci']?>" class="btn btn-secondary">
